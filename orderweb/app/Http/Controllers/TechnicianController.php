...
class TechnicianController extends Controller
{
    ...
    {
        $this->rules['document'] = 'required|numeric|unique:tecnician|min:3|max:99999999999999999999';
    ...
    {
        $this->rules['document'] = 'required|numeric|unique:tecnician,document,'.$id.'|min:3|max:99999999999999999999';
        $validator = Validator::make($request->all(), $this->rules);
        $validator->setAttributeNames($this->traductionAttributes);
        if($validator->fails())
        {
