            ...
            <div class="row form-group">
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <select name="observation_id" id="observation_id" class="form-control">
                        ...
                        <option value="{{ $obsevation['id'] }}" @if($obsevation['id']==$order['observation_id'])
                            selected @endif>{{ $obsevation['description'] }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            <div class="col-lg-6">
                                ...
                                <table id="table_fata" class="table table-striped table-hover">
                                    <thead>
                                        <th>Id</th>
                                        <th>Descripción</th>
                                        <th>Horas</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('order.add_activity', [$order->id, $activity->id]) }}"
                                                    class="btn btn-success btn-circle btn-sm" title="Agregar">
                                ...
                                <table id="table_fata" class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $activity->hours }}</td>
                                            <td>
                                                    <a href="{{ route('order.remove_activity', [$order->id, $activity->id]) }}"
                                                    class="btn btn-danger btn-circle btn-sm" title="Eliminar">
